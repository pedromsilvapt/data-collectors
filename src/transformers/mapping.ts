...
export function mapping<T, U, A, R> ( mapper : Mapper<T, U>, collector ?: Collector<U, any, R> ) : Collector<T, any, R>;
export function mapping<T, U, A, R> ( mapper : Mapper<T, U>, collector ?: Collector<U, any, R> ) : Collector<T, A | U[], R | U[]> {
